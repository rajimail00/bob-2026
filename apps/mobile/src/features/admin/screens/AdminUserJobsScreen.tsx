...
export function AdminUserJobsScreen({ route, navigation }: NativeStackScreenProps<AdminStackParamList, "AdminUserJobs">) {
  ...
  const offeredCount = summary?.offered ?? stats.jobsPosted;
  const takenCount = summary?.taken ?? stats.jobsAssigned;
        ...
        ListHeaderComponent={(
          <YStack gap="$3" paddingTop="$4">
            ...
            <XStack gap="$2" paddingHorizontal="$4">
              ...
              >
                {t("admin.userJobs.offeredWithCount", { count: offeredCount })}
              </Button>
              <Button
                flex={1}
                size="sm"
              ...
              >
                {t("admin.userJobs.takenWithCount", { count: takenCount })}
              </Button>
            </XStack>

            <Text variant="h4" paddingHorizontal="$4">
              {t(kind === "offered" ? "admin.userJobs.offered" : "admin.userJobs.taken")}
            </Text>
