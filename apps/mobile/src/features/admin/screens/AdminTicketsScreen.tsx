...
export function AdminTicketsScreen() {
  ...
  return <Screen padded={false}><AdminHeader title={t("admin.navigation.tickets")} /><AdminSearchBar value={search} onChangeText={setSearch} placeholder={t("admin.common.search")} label={t("admin.tickets.searchLabel")} />
