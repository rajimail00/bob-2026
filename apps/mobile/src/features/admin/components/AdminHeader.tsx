  ...
  return (
    <>
      ...
      >
        ...
        <Pressable onPress={() => setAccountMenuOpen((open) => !open)} role="button" aria-label={t("admin.accessibility.account")} accessibilityState={{ expanded: accountMenuOpen }} style={{ minWidth: 44, minHeight: 44, alignItems: "center", justifyContent: "center" }}>
